...
class Transactions(QWidget):
    ...
    def send_funds(self): 
        ...
        debug_msg_sign = "Command below is defined in py-files/transactions.py line 365:"
        debug_msg_submit = "Command below is defined in py-files/transactions.py line 371:" 
